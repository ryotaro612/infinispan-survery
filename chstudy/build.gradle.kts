...
dependencies {
    ...
    implementation("org.infinispan:infinispan-client-hotrod:16.0.0.Dev02")
    // https://mvnrepository.com/artifact/org.infinispan/infinispan-api
    implementation("org.infinispan:infinispan-api:16.0.0.Dev02")
    // https://mvnrepository.com/artifact/org.infinispan/infinispan-query-dsl
    implementation("org.infinispan:infinispan-query-dsl:16.0.0.Dev02")
    // https://mvnrepository.com/artifact/org.infinispan/infinispan-remote-query-client
    implementation("org.infinispan:infinispan-remote-query-client:16.0.0.Dev02")
